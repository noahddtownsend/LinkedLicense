...
object LicenseMatcher {
    ...
    private val nameTable: Map<String, KClass<out License>> =
        mapOf(
            ...
            "bsd-0-clause" to License.Bsd0Clause::class,
            "bsd 0-clause" to License.Bsd0Clause::class,
            "bsd 0-clause license" to License.Bsd0Clause::class,
            "the bsd 0-clause license" to License.Bsd0Clause::class,
            "0-clause bsd" to License.Bsd0Clause::class,
            "zero-clause bsd" to License.Bsd0Clause::class,
            "bsd zero clause license" to License.Bsd0Clause::class,
            ...
            "bsd 3-clause \"new\" license" to License.Bsd3Clause::class,
            "bsd 3-clause revised license" to License.Bsd3Clause::class,
            "the bsd 3-clause license" to License.Bsd3Clause::class,
            "bsd 3-clause license" to License.Bsd3Clause::class,
            "bsd 3 clause" to License.Bsd3Clause::class,
            "bsd 3 clause license" to License.Bsd3Clause::class,
            "3-clause bsd license" to License.Bsd3Clause::class,
            "3-clause bsd" to License.Bsd3Clause::class,
            "the 3-clause bsd license" to License.Bsd3Clause::class,
            ...
            "mpl-1.0" to License.Mpl1::class,
            "mpl 1.0" to License.Mpl1::class,
            "mozilla public license 1.0" to License.Mpl1::class,
            "mozilla public license, version 1.0" to License.Mpl1::class,
            "mozilla public license version 1.0" to License.Mpl1::class,
            "the mozilla public license 1.0" to License.Mpl1::class,
            "the mozilla public license, version 1.0" to License.Mpl1::class,
            "mpl-1.1" to License.Mpl1_1::class,
            "mpl 1.1" to License.Mpl1_1::class,
            "mozilla public license 1.1" to License.Mpl1_1::class,
            "mozilla public license, version 1.1" to License.Mpl1_1::class,
            "mozilla public license version 1.1" to License.Mpl1_1::class,
            "the mozilla public license 1.1" to License.Mpl1_1::class,
            "the mozilla public license, version 1.1" to License.Mpl1_1::class,
            "mozilla public license (mpl) 1.1" to License.Mpl1_1::class,
            "mozilla public license (mpl), version 1.1" to License.Mpl1_1::class,
            ...
            "epl-2.0" to License.Epl2::class,
            "epl 2.0" to License.Epl2::class,
            "eclipse public license - v 2.0" to License.Epl2::class,
            "eclipse public license - v2.0" to License.Epl2::class,
            "eclipse public license 2.0" to License.Epl2::class,
            "eclipse public license, version 2.0" to License.Epl2::class,
            "eclipse public license version 2.0" to License.Epl2::class,
            "the eclipse public license 2.0" to License.Epl2::class,
            "the eclipse public license, version 2.0" to License.Epl2::class,
            "the eclipse public license version 2.0" to License.Epl2::class,
            "eclipse public license (epl) 2.0" to License.Epl2::class,
            "edl-1.0" to License.Edl1::class,
            "edl 1.0" to License.Edl1::class,
            "edl" to License.Edl1::class,
            "eclipse distribution license - v 1.0" to License.Edl1::class,
            "eclipse distribution license - v1.0" to License.Edl1::class,
            "eclipse distribution license 1.0" to License.Edl1::class,
            "eclipse distribution license, version 1.0" to License.Edl1::class,
            "eclipse distribution license version 1.0" to License.Edl1::class,
            "the eclipse distribution license 1.0" to License.Edl1::class,
            "the eclipse distribution license, version 1.0" to License.Edl1::class,
            "eclipse distribution license (edl) 1.0" to License.Edl1::class,
            "eclipse distribution license" to License.Edl1::class,
            "the eclipse distribution license" to License.Edl1::class,
            "bsl-1.0" to License.Bsl1::class,
            "bsl 1.0" to License.Bsl1::class,
            "boost software license" to License.Bsl1::class,
            "boost software license 1.0" to License.Bsl1::class,
            "boost software license - version 1.0" to License.Bsl1::class,
            "boost software license, version 1.0" to License.Bsl1::class,
            "boost software license version 1.0" to License.Bsl1::class,
            "the boost software license 1.0" to License.Bsl1::class,
            "the boost software license - version 1.0" to License.Bsl1::class,
            "zlib" to License.Zlib::class,
            "zlib license" to License.Zlib::class,
            "the zlib license" to License.Zlib::class,
            "zlib/libpng license" to License.Zlib::class,
            "the zlib/libpng license" to License.Zlib::class,
            "ms-pl" to License.MsPl::class,
            "ms pl" to License.MsPl::class,
            "microsoft public license" to License.MsPl::class,
            "microsoft public license (ms-pl)" to License.MsPl::class,
            "the microsoft public license" to License.MsPl::class,
            "ms-rl" to License.MsRl::class,
            "ms rl" to License.MsRl::class,
            "microsoft reciprocal license" to License.MsRl::class,
            "microsoft reciprocal license (ms-rl)" to License.MsRl::class,
            "the microsoft reciprocal license" to License.MsRl::class,
            ...
            "amazon software license" to License.AmazonSoftwareLicense::class,
            "amazon software license 1.0" to License.AmazonSoftwareLicense::class,
            "amazon software license, version 1.0" to License.AmazonSoftwareLicense::class,
            "the amazon software license" to License.AmazonSoftwareLicense::class,
            "amazon software license (asl)" to License.AmazonSoftwareLicense::class,
            "amazon-sl" to License.AmazonSoftwareLicense::class,
            "asl" to License.AmazonSoftwareLicense::class,
            "embrace license" to License.Embrace::class,
            "embrace software license" to License.Embrace::class,
            "the embrace license" to License.Embrace::class,
            "embrace" to License.Embrace::class,
            "firebase license" to License.Firebase::class,
            "firebase terms" to License.Firebase::class,
            "firebase terms of service" to License.Firebase::class,
            "firebase sdk terms of service" to License.Firebase::class,
            "firebase software development kit terms of service" to License.Firebase::class,
            "firebase software development kit terms" to License.Firebase::class,
            "the firebase terms of service" to License.Firebase::class,
            "android software development kit license" to License.AndroidSdk::class,
            "android software development kit license agreement" to License.AndroidSdk::class,
            "android software development kit terms and conditions" to License.AndroidSdk::class,
            "the android software development kit license" to License.AndroidSdk::class,
            "the android software development kit license agreement" to License.AndroidSdk::class,
            "android sdk license" to License.AndroidSdk::class,
            "android sdk license agreement" to License.AndroidSdk::class,
            "the android sdk license" to License.AndroidSdk::class,
            "android software development license agreement" to License.AndroidSdk::class,
            "android software development license" to License.AndroidSdk::class,
            "android sdk" to License.AndroidSdk::class,
            "google play services license" to License.AndroidSdk::class,
            "google play services" to License.AndroidSdk::class,
        )
    ...
    private val urlTable: List<Pair<Regex, KClass<out License>>> =
        listOf(
            ...
            Regex("opensource\\.org/licenses/0BSD", RegexOption.IGNORE_CASE) to License.Bsd0Clause::class,
            Regex("spdx\\.org/licenses/0BSD", RegexOption.IGNORE_CASE) to License.Bsd0Clause::class,
            ...
            Regex("mozilla\\.org.*MPL/1\\.0", RegexOption.IGNORE_CASE) to License.Mpl1::class,
            Regex("spdx\\.org/licenses/MPL-1\\.0", RegexOption.IGNORE_CASE) to License.Mpl1::class,
            Regex("opensource\\.org/licenses/MPL-1\\.0", RegexOption.IGNORE_CASE) to License.Mpl1::class,
            Regex("mozilla\\.org.*MPL/1\\.1", RegexOption.IGNORE_CASE) to License.Mpl1_1::class,
            Regex("spdx\\.org/licenses/MPL-1\\.1", RegexOption.IGNORE_CASE) to License.Mpl1_1::class,
            Regex("opensource\\.org/licenses/MPL-1\\.1", RegexOption.IGNORE_CASE) to License.Mpl1_1::class,
            ...
            Regex("eclipse\\.org/legal/epl-2\\.0", RegexOption.IGNORE_CASE) to License.Epl2::class,
            Regex("spdx\\.org/licenses/EPL-2\\.0", RegexOption.IGNORE_CASE) to License.Epl2::class,
            Regex("opensource\\.org/licenses/EPL-2\\.0", RegexOption.IGNORE_CASE) to License.Epl2::class,
            Regex("eclipse\\.org/org/documents/edl-v10", RegexOption.IGNORE_CASE) to License.Edl1::class,
            Regex("spdx\\.org/licenses/EDL-1\\.0", RegexOption.IGNORE_CASE) to License.Edl1::class,
            Regex("opensource\\.org/licenses/EDL-1\\.0", RegexOption.IGNORE_CASE) to License.Edl1::class,
            Regex("boost\\.org/LICENSE_1_0\\.txt", RegexOption.IGNORE_CASE) to License.Bsl1::class,
            Regex("spdx\\.org/licenses/BSL-1\\.0", RegexOption.IGNORE_CASE) to License.Bsl1::class,
            Regex("opensource\\.org/licenses/BSL-1\\.0", RegexOption.IGNORE_CASE) to License.Bsl1::class,
            Regex("zlib\\.net/zlib_license", RegexOption.IGNORE_CASE) to License.Zlib::class,
            Regex("spdx\\.org/licenses/Zlib", RegexOption.IGNORE_CASE) to License.Zlib::class,
            Regex("opensource\\.org/licenses/Zlib", RegexOption.IGNORE_CASE) to License.Zlib::class,
            Regex("opensource\\.org/licenses/MS-PL", RegexOption.IGNORE_CASE) to License.MsPl::class,
            Regex("spdx\\.org/licenses/MS-PL", RegexOption.IGNORE_CASE) to License.MsPl::class,
            Regex("opensource\\.org/licenses/MS-RL", RegexOption.IGNORE_CASE) to License.MsRl::class,
            Regex("spdx\\.org/licenses/MS-RL", RegexOption.IGNORE_CASE) to License.MsRl::class,
            Regex("aws\\.amazon\\.com/asl", RegexOption.IGNORE_CASE) to License.AmazonSoftwareLicense::class,
            Regex("embrace\\.io/(?:docs/)?(?:embrace-software-notice|terms-of-service)", RegexOption.IGNORE_CASE) to License.Embrace::class,
            Regex("firebase\\.google\\.com/terms", RegexOption.IGNORE_CASE) to License.Firebase::class,
            Regex("developer\\.android\\.com/(?:studio|sdk)/terms", RegexOption.IGNORE_CASE) to License.AndroidSdk::class,
